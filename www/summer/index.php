...
?>
	...
	<section>
        ...
        <div class="post">
            <div id="left">
                <h1>When</h1>
                <p>Each department will meet once a week, with the exception of Engineering, which meets twice a week, over the six week period of June 22nd and July 31st. This allows students to choose which departments they are interested in attending.</p>
                <table id="when">
                    <tr>
                    ...
                    <tr>
                        <td><strong>Mondays</strong></td>
                        <td><strong>Fridays</strong></td>
                        <td><strong>Th. &amp; Sat.</strong></td>
                        <td><strong>Saturdays</strong></td>
                    </tr>
                </table>
                <p id="time">9:00AM - 12:00PM</p>
            </div>
            <div id="right">
                <h1>Where</h1>
                <p id="noIndent"><a href="https://www.google.com/maps/place/Oxford+Academy/@33.8224281,-118.0425098,18z/data=!3m1!4b1!4m2!3m1!1s0x80dd2e98997e6095:0xf86122ccefa379ec" target="_blank">Oxford Academy, 5172 Orange Ave Cypress, CA | Room 306**</a></p>
                <a href="https://www.google.com/maps/place/Oxford+Academy/@33.8224281,-118.0425098,18z/data=!3m1!4b1!4m2!3m1!1s0x80dd2e98997e6095:0xf86122ccefa379ec" target="_blank"><img src="306map.jpg"></a>
                <p id="noIndent">**Math will meet in an adjacent classroom</p>
            </div>
            <div id="jumpTo">
                <h1>Jump To</h1>
                <table>
        ...
        <div class="department"><a name="science" class="offset"></a>
            ...
            <p id="largerText">Meetings every Monday from 9:00AM to 12:00PM under the direction of Celine Veys, Tiffany Lwin, Abigail Zhong, Samuel Mun, and Mr. Fournier.</p>
            <div id="left">
        ...
        <div class="department"><a name="mathematics" class="offset"></a>
            ...
            <p id="largerText">Meetings every Saturday from 9:00AM to 12:00PM under the direction of Sean Park.</p>
            <div id="left">
...
throughout the school year. You don’t have to join all four of the departments, but you are welcome to join as many departments as you would like.</p>
                <br>
                <p>Q: Who is eligible to be a member?<br>A: Anyone who is going to be between 7th and 12th grade in the following school year is welcome.</p>
                <br>
                <p>Q: How much does it cost to join?<br>A: Nothing! Our program is free for all students.</p>
                <br>
                <p>Q: When are meetings?<br>A: All meetings will be between 9:00AM and 12:00PM with Science on Mondays, Technology on Fridays, Engineering on Thursday and Saturday, and Mathematics on Saturday. Since Mathematics will meet at the same time as the Engineering's Saturday meeting, the Mathematics Department will be in an adjacent classroom.</p><br>
